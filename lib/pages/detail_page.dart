          ...
          Positioned(
            ...
            child: SizedBox(
              ...
              child: AspectRatio(
                aspectRatio: 196 / 285,
                child: Hero(
                  tag: widget.clinic.firstName + widget.clinic.lastName,
                  child: Image(
                    filterQuality: FilterQuality.high,
                    fit: BoxFit.fitHeight,
                    image: AssetImage('assets/images/' + widget.clinic.image),
                  ),
                ),
              ),
            ),
